...
def speech_recognition(audio_data: str, language: str) -> dict:
    try:
        # create folder
        os.makedirs("./output/recognized", exist_ok=True)
        ...
        output_wav_file = (
            f"./output/recognized/{language}_recognized_{current_date}.wav"
        )
        ...
        if result is not None:
            ...
            print(f"Audio recognized saved to {output_wav_file}")
